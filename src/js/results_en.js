	...
	// Age of Discovery 10
	{
      ...
      <p>
		...
		3: {
			title: 'Magical Event',
			subtitle: '',
			desc: '<p>Something magical, powerful, or otherworldly has been discovered. Describe and draw this relic, be sure to give it and the location where it was discovered a name. (for example: Tome of Undeath, Wand of Power, Divine Weapon).</p>',
			img: img('10/3'),
		},
		4: {
			title: 'Evil Lair or Hive',
			subtitle: '',
			desc: '<p>Sinister forces are lurking. Is it demons, twisted abominations, giant spiders? Draw in this new hostile neighbor with an appropriate settlement.</p>',
			img: img('10/4'),
		},
		5: {
			title: 'New Island',
			subtitle: '',
			desc: '<p>Your sea explorers have discovered a new island! Draw 1 small island, roll twice to discover what biomes are on this island located. Place them on it, or near the new island, then name the island after the explorer that discovered it.</p>',
			img: img('10/5'),
		},
		6: {
			title: 'Ancient Ruins',
